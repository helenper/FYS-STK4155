...
#For MSE:
mse_OLS_list = [mse_OLS_average1, mse_OLS_average2, mse_OLS_average3, mse_OLS_average4, mse_OLS_average5]
mse_Ridge_list = [mse_Ridge_average1, mse_Ridge_average2, mse_Ridge_average3, mse_Ridge_average4, mse_Ridge_average5] 
mse_Lasso_list = [mse_Lasso_average1, mse_Lasso_average2, mse_Lasso_average3, mse_Lasso_average4, mse_Lasso_average5]

# For R2 score:
r2score_OLS_list = [r2score_OLS_average1, r2score_OLS_average2, r2score_OLS_average3, r2score_OLS_average4, r2score_OLS_average5]
r2score_Ridge_list = [r2score_Ridge_average1, r2score_Ridge_average2, r2score_Ridge_average3, r2score_Ridge_average4, r2score_Ridge_average5]
r2score_Lasso_list = [r2score_Lasso_average1, r2score_Lasso_average2, r2score_Lasso_average3, r2score_Lasso_average4, r2score_Lasso_average5]
...
# Plotting:
plotMSE(mse_OLS_list,mse_Ridge_list,mse_Lasso_list)
plotR2(r2score_OLS_list, r2score_Ridge_list, r2score_Lasso_list)
#plotVariance(var_OLS_list, var_Ridge_list, var_Lasso_list)
#plotBias(bias_OLS_list, bias_Ridge_list, bias_Lasso_list)
